...
<div class="footer">
    <div class="wrap">
        ...
        <h4>Stay in touch on</h4>
                <ul class="social">
                    <li><img src="/static-assets/images/facebook.png" title="facebook"><a href="#">Facebook</a></li>
                    <li><img src="/static-assets/images/twitter.png" title="twitter"><a href="#">Twitter</a></li>
                    <li><img src="/static-assets/images/gplus.png" title="google+"><a href="#">Google+</a></li>
                </ul>
        </div>
        <div class="clear"> </div>
    </div>
