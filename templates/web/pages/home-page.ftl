    ...
    <div class="left-content">
        ...
        <div class="grids">
            <div class="grid">
                ...
                <a href="single.html"><img src="/static-assets/images/g1 copy.png" title="video-name" /></a>
                <div class="time">
                    <span>00:10</span>
                </div>
                <div class="grid-info">
            ...
            <div class="grid">
                <h3>Consectetur adipisicing elit</h3>
                <a href="single.html"><img src="/static-assets/images/g2 copy.png" title="video-name" /></a>
                <div class="time">
                    <span>2:10</span>
                </div>
                <div class="grid-info">
            ...
            <div class="grid">
                <h3>Consectetur adipisicing elit</h3>
                <a href="single.html"><img src="/static-assets/images/g4.jpg" title="video-name" /></a>
                <div class="time">
                    <span>10:10</span>
                </div>
                <div class="grid-info">
        ...
        <div class="grids">
            <div class="grid">
                <h3>Consectetur adipisicing elit</h3>
                <a href="single.html"><img src="/static-assets/images/g3.jpg" title="video-name" /></a>
                <div class="time">
                    <span>2:30</span>
                </div>
                <div class="grid-info">
            ...
            <div class="grid">
                <h3>Consectetur adipisicing elit</h3>
                <a href="single.html"><img src="/static-assets/images/g5.jpg" title="video-name" /></a>
                <div class="time">
                    <span>5:10</span>
                </div>
                <div class="grid-info">
        ...
        <div class="grids">
            <div class="grid">
                <h3>Consectetur adipisicing elit</h3>
                <a href="single.html"><img src="/static-assets/images/g6.jpg" title="video-name" /></a>
                <div class="time">
                    <span>12:10</span>
                </div>
                <div class="grid-info">
            ...
            <div class="grid">
                <h3>Consectetur adipisicing elit</h3>
                <a href="single.html"><img src="/static-assets/images/g7.jpg" title="video-name" /></a>
                <div class="time">
                    <span>20:10</span>
                </div>
                <div class="grid-info">
            ...
            <div class="grid">
                <h3>Consectetur adipisicing elit</h3>
                <a href="single.html"><img src="/static-assets/images/g8.jpg" title="video-name" /></a>
                <div class="time">
                    <span>2:50</span>
                </div>
                <div class="grid-info">
...
<div class="right-content">
    ...
    <div class="Recent-Vodeos">
        <h3>Recent-Videos</h3>
        <div class="video1">
            <img src="/static-assets/images/r1.jpg" title="video2" />
        ...
        <div class="video1 video2">
            <img src="/static-assets/images/r2.jpg" title="video2" />
            <span>Lorem ipsum dolor sit amet,</span>
            <p>s consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
            <div class="clear"> </div>
        </div>
